...
pub enum MinaLedgerSyncLedgerAnswerStableV2 {
    ...
    AccountWithPath(MinaBaseAccountBinableArgStableV2),
}
...
#[test]
fn tst() {
    let addr: NonZeroCurvePoint = serde_json::from_str("\"B62qmQsEHcsPUs5xdtHKjEmWqqhUPRSF2GNmdguqnNvpEZpKftPC69e\"").unwrap();
    panic!();
}
