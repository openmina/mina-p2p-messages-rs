...
use super::versioned::{Ver, Versioned};

impl super::p2p::MinaStateProtocolStateValueStableV1 {
    pub fn hash(&self, hasher: &mut impl Hasher<Self>) -> StateHashStable {
        use crate::p2p::StateHashStableV1Poly;
        let field = hasher.hash(self);
        StateHashStableV1(StateHashStableV1Poly(field.into())).into()
    }
}

impl super::p2p::MinaStateProtocolStateValueStable {
    pub fn hash(&self, hasher: &mut impl Hasher<Self>) -> StateHashStable {
        use crate::p2p::StateHashStableV1Poly;
        let field = hasher.hash(self);
        StateHashStableV1(StateHashStableV1Poly(field.into())).into()
...
impl Hashable for super::p2p::UnsignedExtendedUInt32StableV1 {
    type D = ();
...
impl Hashable for super::p2p::UnsignedExtendedUInt64StableV1 {
    type D = ();
...
impl Hashable for super::p2p::MinaStateProtocolStateValueStableV1 {
    type D = ();
...
impl Hashable for super::p2p::MinaStateProtocolStateBodyValueStableV1 {
    type D = ();
...
impl Hashable for super::p2p::MinaBaseProtocolConstantsCheckedValueStableV1 {
    type D = ();
...
impl Hashable for super::p2p::ConsensusProofOfStakeDataConsensusStatePolyStableArg0V1 {
    type D = ();
...
impl Hashable for super::p2p::BlockTimeTimeStableV1 {
    type D = ();
...
impl Hashable for super::p2p::MinaStateBlockchainStateValueStableV1 {
    type D = ();
...
impl Hashable for super::p2p::MinaBaseStagedLedgerHashStableV1 {
    type D = ();
...
impl super::p2p::MinaBaseStagedLedgerHashNonSnarkStableV1 {
    pub fn sha256(&self) -> Vec<u8> {
        use sha2::Digest;
        let mut hasher = sha2::Sha256::new();
        let ledger_hash_bytes: Vec<u8> = self.ledger_hash.inner().0 .0.iter_bytes().rev().collect();
        hasher.update(&ledger_hash_bytes);
        hasher.update(self.aux_hash.inner().0.as_bytes());
        hasher.update(&self.pending_coinbase_aux.inner().0.as_bytes());
        hasher.finalize().to_vec()
    }
}

impl Hashable for super::p2p::MinaBaseStagedLedgerHashNonSnarkStableV1 {
    type D = ();
...
impl Hashable for super::p2p::MinaBaseTokenIdStableV1 {
    type D = ();
...
impl Hashable for super::p2p::ConsensusProofOfStakeDataConsensusStateValueStableV1 {
    type D = ();
...
impl Hashable for super::p2p::ConsensusVrfOutputTruncatedStableV1 {
    type D = ();
...
impl Hashable for super::p2p::CurrencyAmountMakeStrStableV1 {
    type D = ();
...
impl Hashable for super::p2p::ConsensusGlobalSlotStableV1 {
    type D = ();
...
impl Hashable for super::p2p::ConsensusGlobalSlotPolyStableArg0V1 {
    type D = ();
...
impl Hashable for super::p2p::ConsensusProofOfStakeDataEpochDataStakingValueVersionedValueStableV1 {
    type D = ();
...
impl Hashable for super::p2p::MinaBaseEpochDataPolyStableArg1V1 {
    type D = ();
...
impl Hashable for super::p2p::MinaBaseEpochLedgerValueStableV1 {
    type D = ();
...
impl Hashable for super::p2p::MinaBaseStagedLedgerHashNonSnarkStableV1LedgerHashV1 {
    type D = ();
...
impl Hashable for super::p2p::ConsensusProofOfStakeDataEpochDataNextValueVersionedValueStableV1 {
    type D = ();
